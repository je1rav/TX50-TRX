 ...
 * 
 * TX50_XIAO_RP2040.ino
 * 
 * TX50_XIAO_RP2040.ino is free software: you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * any later version.
 * 
 * TX50_XIAO_RP2040.ino is distributed in the hope that it will be useful,
...
#define N_FREQ 7 // number of using RF frequencies　(<= 7)
#define FREQ_0 50400000 // RF frequency in Hz
#define FREQ_1 50500000 // in Hz
#define FREQ_2 50550000 // in Hz
#define FREQ_3 50600000 // in Hz
#define FREQ_4 50620000 // in Hz
#define FREQ_5 50650000 // in Hz
#define FREQ_6 50700000 // in Hz
uint64_t Freq_table[N_FREQ]={FREQ_0,FREQ_1,FREQ_2,FREQ_3,FREQ_4,FREQ_5,FREQ_6}; // Freq_table[N_FREQ]={FREQ_0,FREQ_1, ...}
