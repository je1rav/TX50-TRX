...
この論文での実際の出力は不明ですが，10mWよりは大きいと考えられますので，今回の場合，1m程度のロッドアンテナで十分に規制値を下回るものと考えられます．  
...
### 2．アンテナとマッチング回路  
	玩具トランシーバーは，電波が著しく微弱な無線局で，免許不要ですが，そのための条件があります．  
	上記の電波研究所の論文を参考にすると，今回の場合，1m程度のロッドアンテナで十分に規制値を下回るものと考えられます．
...
アマチュア無線の28MHz帯は，周波数が近いので，コアの調整は必要ですが，ハードウエアはそのまま使用できます．  
ロッドアンテナ以外のアンテナを使用する場合，10mm角FCZコイル28MHz用+33pFコンデンサ)を取り付けないで，T2の1番ピンと5番ピンをショートし，お好きなアンテナをお付けください．  
